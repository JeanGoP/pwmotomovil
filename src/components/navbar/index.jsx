  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div className="container-fluid px-4">
        ...
        >
          <div className='borde-imagen-menu'>
          <img src="/images/logoMotoAndes.png" alt="Logo Motomovil" className="logo-left "/>
          {/* <div className="d-flex flex-column ms-1">
            <span className="menu--titulo--img">Motomovil</span>
            <span className="text-muted menu--subtitulo--img">Distribuidora autorizada de Suzuki</span>
          </div> */}
        </div>
        </div>
        {/* Botón toggler */}
