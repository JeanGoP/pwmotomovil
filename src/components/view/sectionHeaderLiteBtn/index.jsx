...
const SectionHeaderLiteBtn = ({ titulo, cuerpo, urlyoutube='', opcion='A' }) => {
    ...
    if(opcion='A'){
        return (
            <div className="section-header-Lite text-center">
                <p className="section-title-Lite" style={{color:'#fff'}}>
                    {titulo}
                </p>
                <p className="section-subtitle-Lite" style={{color:'#fff'}}>
                    {cuerpo}
                </p>
    ...
    if(opcion='B'){
        return (
            <div className="section-header-Lite text-center">
                <p className="section-title-Lite" style={{color:'#003e8b !important'}}>
                    {titulo}
                </p>
