...
import { Zap, Target, Users, Handshake, Award, Lightbulb, Bike, Wrench, Info,ArrowRight } from "lucide-react";
import { FaRegHeart } from "react-icons/fa";
import './card.css'
import { Settings } from "lucide-react";
import { Package } from "lucide-react";

const Cards = ({ icono = '', titulo, cuerpo, categoria = '', precio = '', listaItems = [], imagen = '', opcion, btn = '', franja = '', menu = '', motObject = null, whatsapp = '', cilindraje = '', colorfondo ='#f9fafb' }) => {
    ...
    return (
      <div className="moto-card" onClick={() => handleMotocicleta(motObject)}>
        ...
        <div className="moto-card-body">
          ...
          <button className="moto-btn" onClick={() => handleMotocicleta(motObject)}>VER MÁS  <ArrowRight  className="moto-icono-right"/> </button>
        </div>
      </div>
    )
  }
  ...
  if (opcion = 'EL') {
    return (
      <div className="card-mantenimientoEL  h-100" style={{background:colorfondo}}>
